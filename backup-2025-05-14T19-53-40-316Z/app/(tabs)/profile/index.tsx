...
import { Plus, CircleCheck as CheckCircle2, Heart, Settings, X } from 'lucide-react-native';
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { backgroundColor: colors.background }]}>
        <View style={styles.logo}>
          <Text style={[styles.name, { color: colors.tint }]}>Gymsta</Text>
          <TouchableOpacity 
      ...
      <ScrollView style={{ backgroundColor: colors.background }}>
        <TouchableOpacity 
          ...
          />
          <TouchableOpacity 
            style={[styles.plusIconContainer, uploadingStory && styles.uploadingContainer]}
